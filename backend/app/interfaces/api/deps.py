...
def require_runtime_entitlement(feature: str):
    """Validate the current signed lease at request admission time."""

    def dependency(request: Request) -> None:
        request.app.state.entitlement_gate.require(feature)
