...
class TikTokVideoMetricDbTable(SQLModel, table=True):
    ...
    repost_count: Optional[int] = Field(default=None)
    download_count: Optional[int] = Field(default=None)
    cover_url: str = Field(default="")
    share_url: str = Field(default="")
    duration_seconds: Optional[int] = Field(default=None)
    max_quality: str = Field(default="")
    detail_source: str = Field(default="")
    region: str = Field(default="")
    shadow_ban: str = Field(default="UNKNOWN")
    shadow_ban_reason: str = Field(default="")
    index_enabled: Optional[bool] = Field(default=None)
    is_reviewing: bool = Field(default=False)
