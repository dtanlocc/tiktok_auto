...
user_pref("app.normandy.user_id", "ee997929-578e-44a7-b5de-2644258ef874");
...
user_pref("app.update.lastUpdateTime.recipe-client-addon-run", 1787889705);
user_pref("app.update.lastUpdateTime.region-update-timer", 0);
user_pref("app.update.lastUpdateTime.rs-experiment-loader-timer", 1787889703);
user_pref("app.update.lastUpdateTime.suggest-ingest", 1787889696);
user_pref("app.update.lastUpdateTime.xpi-signature-verification", 0);
user_pref("app.update.migrated.updateDir3.8FA159B34D6B75C5", true);
user_pref("browser.aboutConfig.showWarning", false);
user_pref("browser.aboutwelcome.enabled", false);
user_pref("browser.bookmarks.restore_default_bookmarks", false);
user_pref("browser.contentblocking.category", "custom");
user_pref("browser.contentblocking.report.lockwise.enabled", false);
user_pref("browser.contextual-services.contextId", "927bfa27-3ca1-4e79-940b-98bdce043833");
user_pref("browser.contextual-services.contextId.timestamp-in-seconds", 1787889696);
...
user_pref("browser.newtabpage.activity-stream.discoverystream.sections.interestPicker.visibleSections", "top_stories_section,education-science,small-wins,mlb,music,by-the-numbers,arts,in-conversation,nfl,food,government,explained,travel,connections,health,featured-videos,movies,photojournalism,nhl,long-reads");
user_pref("browser.newtabpage.activity-stream.discoverystream.sections.personalization.inferred.enabled", true);
user_pref("browser.newtabpage.activity-stream.impressionId", "{65b6e704-a0fc-42a2-997f-f8038b4d636a}");
...
user_pref("browser.region.update.updated", 1787889694);
user_pref("browser.safebrowsing.downloads.remote.enabled", false);
user_pref("browser.safebrowsing.provider.mozilla.lastupdatetime", "1787889708086");
user_pref("browser.safebrowsing.provider.mozilla.nextupdatetime", "1787911308086");
user_pref("browser.search.geoSpecificDefaults", false);
user_pref("browser.search.region", "US");
user_pref("browser.search.serpEventTelemetryCategorization.regionEnabled", true);
user_pref("browser.shell.checkDefaultBrowser", false);
user_pref("browser.shell.mostRecentDateSetAsDefault", "1787889694");
user_pref("browser.startup.couldRestoreSession.count", 1);
user_pref("browser.startup.lastColdStartupCheck", 1787889694);
user_pref("browser.topsites.contile.cacheValidFor", 10800);
user_pref("browser.topsites.contile.lastFetch", 1787889698);
user_pref("browser.uiCustomization.state", "{\"placements\":{\"widget-overflow-fixed-list\":[],\"unified-extensions-area\":[\"omocaptcha_gmail_com-browser-action\"],\"nav-bar\":[\"back-button\",\"forward-button\",\"stop-reload-button\",\"customizableui-special-spring1\",\"vertical-spacer\",\"urlbar-container\",\"customizableui-special-spring2\",\"downloads-button\",\"ipprotection-button\",\"fxa-toolbar-menu-button\",\"reset-pbm-toolbar-button\",\"unified-extensions-button\"],\"toolbar-menubar\":[\"menubar-items\"],\"TabsToolbar\":[\"firefox-view-button\",\"tabbrowser-tabs\",\"new-tab-button\",\"alltabs-button\"],\"vertical-tabs\":[],\"PersonalToolbar\":[\"personal-bookmarks\"]},\"seen\":[\"reset-pbm-toolbar-button\",\"omocaptcha_gmail_com-browser-action\",\"developer-button\",\"screenshot-button\",\"ipprotection-button\"],\"dirtyAreaCache\":[\"unified-extensions-area\",\"nav-bar\",\"vertical-tabs\"],\"currentVersion\":24,\"newElementCount\":2}");
user_pref("browser.urlbar.placeholderName", "Google");
user_pref("browser.urlbar.quicksuggest.migrationVersion", 7);
user_pref("captchadetection.lastSubmission", 1787889);
user_pref("datareporting.dau.cachedUsageProfileGroupID", "453cffdc-6f54-448f-968a-9ef5de41fa61");
user_pref("datareporting.dau.cachedUsageProfileID", "526bba6c-1420-427a-a00f-c0e96102b456");
...
user_pref("dom.push.userAgentID", "7cc1f974590b4887b45f797e8b6acb9c");
...
user_pref("extensions.dnr.lastStoreUpdateTag.d6105ea0-8d34-41ab-85a7-2eb0c66d55bb", "{a0a06403-a572-4dbc-b604-c3ed9a589207}");
user_pref("extensions.enabledScopes", 15);
user_pref("extensions.getAddons.databaseSchema", 6);
user_pref("extensions.lastAppBuildId", "20260827000135");
...
user_pref("extensions.webextensions.ExtensionStorageIDB.migrated.omocaptcha@gmail.com", true);
user_pref("extensions.webextensions.uuids", "{\"omocaptcha@gmail.com\":\"d6105ea0-8d34-41ab-85a7-2eb0c66d55bb\",\"data-leak-blocker@mozilla.com\":\"ca2d5dce-9c8f-4485-8f82-5b52d8d8e18e\",\"formautofill@mozilla.org\":\"36cd49c1-75cb-4951-bcdc-02c4c2889f16\",\"ipp-activator@mozilla.com\":\"f72014c0-2479-49ab-a12e-00dbef28103d\",\"pictureinpicture@mozilla.org\":\"c12c7c03-4755-4f75-aa53-fc0fc51781f8\",\"addons-search-detection@mozilla.com\":\"10068c1e-5353-4c43-b3ec-5d28c92ddb07\",\"webcompat@mozilla.org\":\"9a310967-e580-48bf-b3e8-4eafebbc122d\",\"newtab@mozilla.org\":\"047e586b-04d2-467c-bf9d-28c91ea4f917\",\"default-theme@mozilla.org\":\"d5543580-13b4-43cb-9bd5-d300eccb2631\"}");
...
user_pref("nimbus.profileId", "2d0e8afd-d062-489c-bfef-a13e7adcfbe5");
...
user_pref("sanity-test.driver-version", "32.0.16.1047");
user_pref("sanity-test.running", false);
user_pref("sanity-test.version", "20260827000135");
...
user_pref("toolkit.profiles.storeID", "99a84268");
user_pref("toolkit.startup.last_success", 1787889690);
user_pref("toolkit.telemetry.cachedClientID", "5b0879a1-baaf-464a-b848-41e39216f930");
user_pref("toolkit.telemetry.cachedProfileGroupID", "43144aab-c8d0-4fc4-bf7b-0595134043fb");
user_pref("toolkit.telemetry.previousBuildID", "20260827000135");
