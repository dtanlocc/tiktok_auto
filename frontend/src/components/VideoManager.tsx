...
interface Batch { id: string; status: string; created_at: string; account_count: number; videos_per_account?: number; total: number; submitted: number; completed: number; processed?: number; failed?: number; archived?: number; archive_failed?: number; duplicates?: number; refused_parked?: number; refused_park_failed?: number; swallowed?: number; replacements?: number }
